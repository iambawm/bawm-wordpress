...
<div id="aiovg-dashboard" class="aiovg aiovg-dashboard wrap about-wrap full-width-layout">
    ...
    <?php if ( aiovg_fs()->is__premium_only() ) : ?>
        <p class="about-text">
            <a href="https://plugins360.com/all-in-one-video-gallery/using-premium-features/" class="button button-hero" target="_blank">
                <?php esc_html_e( 'Documentation (Premium Version)', 'all-in-one-video-gallery' ); ?>
            </a>
        </p>
    <?php endif; ?>
